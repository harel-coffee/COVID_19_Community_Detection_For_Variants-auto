...
for clust_ind in range(len(number_of_clusters)):
    ...
    np.save('/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/fuzzy/org/new_no_feature_selection_Labels_fuzzy.npy', labels)
    ...
    write_path_112 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/fuzzy/org/new_no_feature_selection_int_true_variants_k_" + str(clust_num) + ".csv"
    ...
    write_path_11 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/fuzzy/org/new_no_feature_selection_orig_true_variants_k_" + str(clust_num) + ".csv"
