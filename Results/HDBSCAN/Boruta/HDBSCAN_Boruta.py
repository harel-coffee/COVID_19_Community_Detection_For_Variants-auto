...
for clust_ind in range(len(number_of_clusters)):
    ...
    np.save('C:\\Users\\ztayebi1\\PycharmProjects\\HierarchyClustering\\Final_Results\\Boruta\\new_Labels_HDBSCAN_Boruta.npy', HDBSCAN_labels)
    ...
    write_path_112 = "C:\\Users\\ztayebi1\\PycharmProjects\\HierarchyClustering\\Final_Results\\Boruta\\new_int_true_variants_k_" + str(clust_num) + ".csv"
    ...
    write_path_11 = "C:\\Users\\ztayebi1\\PycharmProjects\\HierarchyClustering\\Final_Results\\Boruta\\new_orig_true_variants_k_" + str(clust_num) + ".csv"
