...
for clust_ind in range(len(number_of_clusters)):
    ...
    model.fit(X_features_test_RFT)
    labels = model.labels_
    
    # kmeans = KMeans(n_clusters=clust_num, random_state=0).fit(X_features_test_RFT)
    # kmean_clust_labels = kmeans.labels_
    
    np.save('/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/hierarchy/RFT/new_Labels_hierarchy_RFT.npy', labels)
    ...
    write_path_112 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/hierarchy/RFT/new_int_true_variants_k_" + str(clust_num) + ".csv"
    ...
    write_path_11 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/hierarchy/RFT/new_orig_true_variants_k_" + str(clust_num) + ".csv"
