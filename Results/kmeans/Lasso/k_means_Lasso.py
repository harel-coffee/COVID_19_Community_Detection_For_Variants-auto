...
for clust_ind in range(len(number_of_clusters)):
    ...
    np.save('/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/kmeans/Lasso/new_Labels_kmeans_Lasso.npy', kmean_clust_labels)
    ...
    write_path_112 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/kmeans/Lasso/new_int_true_variants_k_" + str(clust_num) + ".csv"
    ...
    write_path_11 = "/alina-data1/Zara/Host_clustering/results/5Clusters_Clustering/kmeans/Lasso/new_orig_true_variants_k_" + str(clust_num) + ".csv"
